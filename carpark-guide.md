...
![s1 s2 git tags](screenshots/evidence-s1-s2-gittags.png)
...
> I should test this behaviour in the CarPark unit tets beause it belongs to the CarPark class. We test a class inside its own unit test file. 
